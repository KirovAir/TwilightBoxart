...
public static class ImageSniffer
{
    ...
    {
        return StartsWith(data, [0x89, (byte)'P', (byte)'N', (byte)'G', 0x0D, 0x0A, 0x1A, 0x0A]) // PNG
    ...
    {
        return data.Length >= 12 && StartsWith(data, "RIFF"u8) && data.Slice(8, 4).SequenceEqual("WEBP"u8);
    }
}
